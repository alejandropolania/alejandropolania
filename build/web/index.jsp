...
<html>
    ...
    <body>           
        <div class="row-sm-4">
            ...
            <div class="form-group">
                            <button id="btnenviar" onclick="cargarTabla()" class="btn btn-outline-info">cargarTabla</button>
                             
                        </div>    
                        
            <div class="form-group">
                            <button id="btnenviar" onclick="actualizar()" class="btn btn-outline-info">actualizar</button>
